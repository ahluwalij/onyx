...
> = {
  web: {
    ...
    values: [
      {
        type: "text",
        query: "Enter the website URL to scrape e.g. https://universalagi.com/:",
        label: "Base URL",
        name: "base_url",
        optional: false,
      },
            ...
            fields: [
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow UniversalAGI to index everything in the shared drives you have access to."
                    : "This will allow UniversalAGI to index everything in your Organization's shared drives.";
                },
              ...
              },
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow UniversalAGI to index everything in your My Drive."
                    : "This will allow UniversalAGI to index everything in everyone's My Drives.";
                },
              ...
              },
              {
                type: "checkbox",
                description:
                  "This will allow UniversalAGI to index all files shared with you.",
    ...
    values: [
      {
        ...
        optional: true,
        description: `Specify the Salesforce object types you want us to index. If unsure, don't specify any objects and UniversalAGI will default to indexing by 'Account'.
...
• Specifying 'https://universalagi.com' for example will only index documents within this site.

• Specifying 'https://universalagi.com' for example will only index documents within this folder.
`,
      },
    ],
    advanced_values: [],
    ...
    values: [
      {
        ...
        name: "teams",
        optional: true,
        description: `Specify 0 or more Teams to index. For example, specifying the Team 'Support' for the 'UniversalAI' Org will cause us to only index messages sent in channels belonging to the 'Support' Team. If no Teams are specified, all Teams in your organization will be indexed.`,
      },
    ],
    advanced_values: [],
  },
    ...
    values: [
      {
        ...
        name: "base_url",
        optional: false,
        description: `Specify the base URL for your Slab team. This will look something like: https://universalagi.com`,
      },
    ],
    advanced_values: [],
  },
