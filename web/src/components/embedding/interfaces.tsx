...
export const AVAILABLE_MODELS: HostedEmbeddingModel[] = [
  ...
  },
  {
    ...
    normalize: true,
    description:
      "The smallest and fastest version of the E5 line of models. If you're running UniversalAGI on a resource constrained system, then this may be a good choice.",
...
export const AVAILABLE_CLOUD_PROVIDERS: CloudEmbeddingProvider[] = [
  {
    ...
    icon: CohereIcon,
    docsLink: "https://universalagi.com",
    description:
