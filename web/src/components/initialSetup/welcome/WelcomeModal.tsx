  ...
  return (
    <>
      ...
      <Modal
        ...
        title={"Welcome to UniversalAGI!"}
        width="w-full max-h-[900px] overflow-y-scroll max-w-3xl"
      >
        <div>
          <Text className="mb-4">
            UniversalAGI brings all your company&apos;s knowledge to your fingertips,
            ready to be accessed instantly.
          </Text>
          <Text className="mb-4">
            To get started, we need to set up an API key for the Language Model
            (LLM) provider. This key allows UniversalAGI to interact with the AI model,
