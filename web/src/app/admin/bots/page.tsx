  ...
  return (
    <div className="mb-8">
      ...
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to UniversalAGI. Once setup, you will be able to
        ask questions to UniversalAGI directly from Slack. Additionally, you can:
      </p>

      <div className="mb-2">
        <ul className="list-disc mt-2 ml-4 text-sm text-muted-foreground">
          <li>
            Setup UniversalAGIBot to automatically answer questions in certain channels.
          </li>
          <li>
            Choose which document sets UniversalAGIBot should answer from, depending on
            the channel the question is being asked.
          </li>
          <li>
            Directly message UniversalAGIBot to search just as you would in the web UI.
          </li>
        </ul>
      </div>
      ...
      <p className="mb-6 text-sm text-muted-foreground">
        ...
        found in the UniversalAGI documentation to get started!
      </p>
