      ...
      <div className="w-full">
          ...
          <>
            ...
            <div className="mt-4 p-4 bg-background rounded-md border border-neutral-300">
              ...
              <p className="mt-2 text-sm italic">
                Warning: Disabling the default configuration means UniversalAGIBot
                won&apos;t respond in Slack channels unless they are explicitly
                configured. Additionally, UniversalAGIBot will not respond to DMs.
              </p>
            </div>
          </>
        )}
        ...
        <div className="space-y-2 mt-4">
          ...
          >
            <RadioGroupItemField
              ...
              sublabel="Let UniversalAGIBot respond based on information from all public connectors"
            />
        ...
        {values.knowledge_source === "document_sets" &&
          documentSets.length > 0 && (
            <div className="mt-4">
              <SubLabel>
                <>
                  Select the document sets UniversalAGIBot will use while answering
                  questions in Slack.
                  <br />
                        ...
                        <div className="mb-3 mt-2 flex gap-2 flex-wrap text-sm">
                          {unselectableSets.map((documentSet) => (
                            <DocumentSetSelectable
                              ...
                              documentSet={documentSet}
                              disabled
                              disabledTooltip="Unable to use this document set because it contains a connector with auto-sync permissions. UniversalAGIBot's responses in this channel are visible to all Slack users, so mirroring the asker's permissions could inadvertently expose private information."
                              isSelected={false}
                              onSelect={() => {}}
                            />
                          ))}
        ...
        {values.knowledge_source === "assistant" && (
          <div className="mt-4">
            <SubLabel>
              <>
                Select the search-enabled assistant UniversalAGIBot will use while
        ...
        {values.knowledge_source === "non_search_assistant" && (
          <div className="mt-4">
            <SubLabel>
              <>
                Select the non-search assistant UniversalAGIBot will use while answering
                questions in Slack.
                {syncEnabledAssistants.length > 0 && (
                  <>
                    <br />
              ...
              <div className="space-y-4">
                <div className="w-64">
                  <SelectorFormField
                    name="response_type"
                    label="Answer Type"
                    tooltip="Controls the format of UniversalAGIBot's responses."
                    options={[
          ...
          <AccordionContent className="overflow-visible">
            <div className="space-y-4">
              <CheckFormField
                ...
                tooltip="If set, will show a button at the bottom of the response that allows the user to continue the conversation in the UniversalAGI Web UI"
              />
              ...
              <CheckFormField
                ...
                tooltip={`UniversalAGIBot's response will include a button at the bottom 
              ...
              <CheckFormField
                ...
                tooltip="If set, UniversalAGIBot will only respond to messages that contain a question mark"
              />
              <CheckFormField
                name="respond_tag_only"
                label="Respond to @UniversalAGIBot Only"
                tooltip="If set, UniversalAGIBot will only respond when directly tagged"
              />
              <CheckFormField
                name="respond_to_bots"
                label="Respond to Bot messages"
                tooltip="If not set, UniversalAGIBot will always ignore messages from Bots"
              />
              <CheckFormField
                name="is_ephemeral"
                label="Respond to user in a private (ephemeral) message"
                tooltip="If set, UniversalAGIBot will respond only to the user in a private (ephemeral) message. If you also 
              ...
              <TextArrayField
                ...
                subtext={
                  "If specified, UniversalAGIBot responses will only " +
