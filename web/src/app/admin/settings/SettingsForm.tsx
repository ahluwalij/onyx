  ...
  return (
    <div className="flex flex-col pb-8">
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use UniversalAGI."
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              anyone to use UniversalAGI without signing in.
            </p>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like UniversalAGI to retain chat messages. Leaving this field empty will cause UniversalAGI to never delete chat messages."
