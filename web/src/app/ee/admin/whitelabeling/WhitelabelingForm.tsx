        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving UniversalAGI for your team. This will replace 'UniversalAGI' everywhere in the UI.`}
              placeholder="Custom name which will replace 'UniversalAGI'"
            ...
            <div>
              ...
              {values.use_custom_logo ? (
                ...
                <SubLabel>
                  Specify your own logo to replace the standard UniversalAGI logo.
                </SubLabel>
              )}
                  ...
                  subtext={
                    values.enable_consent_screen
                      ...
                      : `The title for the popup that will be displayed for each user on their initial visit to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${
                          values.application_name || "UniversalAGI"
                        }!".`
                  }
                  placeholder={
                    values.enable_consent_screen
