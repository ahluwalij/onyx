    ...
    <AuthFlowContainer>
      <div className="flex flex-col space-y-6">
        ...
        <p className="text-text-700 max-w-md text-center">
          We couldn&apos;t find your account in our records. To access UniversalAGI, you
          need to either:
        </p>
        <ul className="list-disc text-left text-text-600 w-full pl-6 mx-auto">
          <li>Be invited to an existing UniversalAGI team</li>
          <li>Create a new UniversalAGI team</li>
        </ul>
